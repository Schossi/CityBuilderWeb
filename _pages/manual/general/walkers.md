...
An important field of the [Walker Component](https://citybuilderapi.softleitner.com/class_city_builder_core_1_1_walker.html) is the Pivot. The Pivot is a transform in the center and root of the Walker. It is used to transform and rotate the Walker. If any of these things go wrong check that the Pivot is correctly assigned.

## Path Types

Among other base functions Walkers have a setting for PathType in their [WalkerInfo](https://citybuilderapi.softleitner.com/class_city_builder_core_1_1_walker_info.html) which specifies the kind of pathfinding it will use to get to its destination.
