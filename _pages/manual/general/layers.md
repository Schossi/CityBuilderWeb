...
At the start of the game the layers base values are calculated using predefined tiles. After that LayerAffectors can register with the Layersystem to add their own values.
