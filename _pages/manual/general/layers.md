...
At the start of the game a layers base values are calculated using predefined tiles. After that LayerAffectors can register with the Layersystem to add their own values.
